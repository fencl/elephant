            ...
            case 1: for (;;) {
                ...
                if (sym < 256) {
                    *s.out++ = sym;
                    ...
                    u16_t len = len_base[sym] + 3 + read(&s, ((sym / 4) - !!(sym / 4)) * !(sym / 28), 1);
                    u8_t  ds  = read(&s, 5, 0);
                    u16_t dst = (((2 + ds % 2) << 13) >> (29 - ds) / 2) + !!ds + read(&s, (ds / 2) - !!(ds / 2), 1);
            ...
            case 2: {
                ...
                for (;;) {
                    ...
                    if (sym < 256) *s.out++ = sym;
                        ...
                        u16_t l = len_base[sym] + 3 + read(&s, ((sym / 4) - !!(sym / 4)) * !(sym / 28), 1);
